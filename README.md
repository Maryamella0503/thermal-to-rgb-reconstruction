...
├── baseline/          # Baseline pipeline (SD1.5 + ControlNet depth)
├── tadn/              # TADN preprocessing module
├── evaluation/        # Edge-based precision, recall, F1 scripts
├── outputs/           # Generated RGB outputs (baseline and TADN)
├── results/           # CSV files containing quantitative evaluation results
